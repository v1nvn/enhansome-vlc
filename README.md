# Awesome VLC [![Awesome](https://awesome.re/badge.svg)](https://awesome.re) [<img src="https://cdn.worldvectorlogo.com/logos/vlc.svg" align="right" alt="VLC" width="128">](https://github.com/mfkl/awesome-vlc) ⭐ 257 | 🐛 0 | 📅 2025-04-28 with stars
...
* [vlc-pause-click-plugin](https://github.com/nurupo/vlc-pause-click-plugin) ⭐ 1,145 | 🐛 18 | 🌐 C | 📅 2025-01-28 - Plugin for VLC that pauses/plays video on mouse click.
* [vlc-bittorrent](https://github.com/johang/vlc-bittorrent) ⭐ 473 | 🐛 8 | 🌐 C++ | 📅 2026-02-04 - A bittorrent plugin for VLC.
* [vlc-win10smtc](https://github.com/spmn/vlc-win10smtc) ⭐ 104 | 🐛 1 | 🌐 C++ | 📅 2024-10-06 - Plugin that integrates VLC Media Player with Windows 10 System Media Transport Controls (SMTC).
* [vlc-tip-plugin](https://github.com/aklexel/vlc-tip-plugin) ⭐ 61 | 🐛 2 | 🌐 C | 📅 2020-05-24 - TIP (translate it, please) is a plugin for VLC media player that helps you to study languages by watching videos.
...
* [vlc-delete](https://github.com/surrim/vlc-delete) ⭐ 107 | 🐛 6 | 🌐 Lua | 📅 2025-12-25 - VLC extension to remove videos from the hard disk.
...
* [LibVLCSharp](https://github.com/videolan/libvlcsharp) ⭐ 1,741 | 🐛 4 | 🌐 C# | 📅 2026-01-20 - Cross-platform .NET/Mono bindings for LibVLC.
* [vlcj](https://github.com/caprica/vlcj) ⭐ 1,225 | 🐛 1 | 🌐 Java | 📅 2026-02-13 -  Java framework for the vlc media player (desktop).
