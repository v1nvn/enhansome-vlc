...
* [vlc-pause-click-plugin](https://github.com/nurupo/vlc-pause-click-plugin) ⭐ 1,169 | 🐛 19 | 🌐 C | 📅 2025-01-28 - Plugin for VLC that pauses/plays video on mouse click.
* [vlc-bittorrent](https://github.com/johang/vlc-bittorrent) ⭐ 480 | 🐛 8 | 🌐 C++ | 📅 2026-03-11 - A bittorrent plugin for VLC.
* [vlc-win10smtc](https://github.com/spmn/vlc-win10smtc) ⭐ 117 | 🐛 1 | 🌐 C++ | 📅 2024-10-06 - Plugin that integrates VLC Media Player with Windows 10 System Media Transport Controls (SMTC).
...
* [LibVLCSharp](https://github.com/videolan/libvlcsharp) ⭐ 1,771 | 🐛 3 | 🌐 C# | 📅 2026-04-21 - Cross-platform .NET/Mono bindings for LibVLC.
