...
* [vlc-pause-click-plugin](https://github.com/nurupo/vlc-pause-click-plugin) ⭐ 1,175 | 🐛 19 | 🌐 C | 📅 2025-01-28 - Plugin for VLC that pauses/plays video on mouse click.
...
* [LibVLCSharp](https://github.com/videolan/libvlcsharp) ⭐ 1,779 | 🐛 3 | 🌐 C# | 📅 2026-04-21 - Cross-platform .NET/Mono bindings for LibVLC.
* [vlcj](https://github.com/caprica/vlcj) ⭐ 1,236 | 🐛 1 | 🌐 Java | 📅 2026-02-22 -  Java framework for the vlc media player (desktop).
...
* [python-vlc](https://github.com/oaubert/python-vlc) ⭐ 442 | 🐛 92 | 🌐 Python | 📅 2025-06-09 - Python vlc bindings.
