# Awesome VLC [![Awesome](https://awesome.re/badge.svg)](https://awesome.re) [<img src="https://cdn.worldvectorlogo.com/logos/vlc.svg" align="right" alt="VLC" width="128">](https://github.com/mfkl/awesome-vlc) ⭐ 274 | 🐛 0 | 📅 2026-03-18 with stars
...
* [vlc-pause-click-plugin](https://github.com/nurupo/vlc-pause-click-plugin) ⭐ 1,173 | 🐛 19 | 🌐 C | 📅 2025-01-28 - Plugin for VLC that pauses/plays video on mouse click.
* [vlc-bittorrent](https://github.com/johang/vlc-bittorrent) ⭐ 483 | 🐛 8 | 🌐 C++ | 📅 2026-03-11 - A bittorrent plugin for VLC.
* [vlc-win10smtc](https://github.com/spmn/vlc-win10smtc) ⭐ 118 | 🐛 1 | 🌐 C++ | 📅 2024-10-06 - Plugin that integrates VLC Media Player with Windows 10 System Media Transport Controls (SMTC).
...
* [vlc-auto-dir-enqueue-prev-next](https://github.com/eltoro0815/vlc-auto-dir-enqueue-prev-next) ⭐ 5 | 🐛 1 | 🌐 Lua | 📅 2025-09-19 - Automatically adds the previous and next track from the same directory to the VLC playlist as soon as a file starts playing.
...
* [LibVLCSharp](https://github.com/videolan/libvlcsharp) ⭐ 1,777 | 🐛 3 | 🌐 C# | 📅 2026-04-21 - Cross-platform .NET/Mono bindings for LibVLC.
...
* [python-vlc](https://github.com/oaubert/python-vlc) ⭐ 441 | 🐛 92 | 🌐 Python | 📅 2025-06-09 - Python vlc bindings.
